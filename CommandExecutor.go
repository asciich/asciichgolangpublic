...
type CommandExecutor interface {
	...
	MustRunCommandAngGetStdoutAsLines(options *RunCommandOptions) (stdoutLines []string)
	...
	RunCommandAngGetStdoutAsLines(options *RunCommandOptions) (stdoutLines []string, err error)
