...
func (r *RunCopilotCliContainerOptions) GetKeepStoppedContainer() (keepStoppedContainer bool) {
	return r.KeepStoppedContainer
}

func (r *RunCopilotCliContainerOptions) SetKeepStoppedContainer(keepStoppedContainer bool) {
	r.KeepStoppedContainer = keepStoppedContainer
}
