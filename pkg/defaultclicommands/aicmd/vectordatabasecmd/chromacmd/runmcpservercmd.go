...
Example usage:
  ` + os.Args[0] + ` ai vectordatabase chroma run-mcp-server --port=3001 --ollama-url='http://localhost:11434' --chroma-url='http://chroma.example.com' --chroma-collection-name="examplecollection" --verbose
`,
