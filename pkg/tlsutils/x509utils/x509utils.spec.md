...
- Generic functions like `GetCommonName(cert *x509.Certificate) (string, error)` which do not require network or file access are implemented in the subpackage `genericx509utils`.
