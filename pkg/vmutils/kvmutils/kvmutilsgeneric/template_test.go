...
func newTestCreateOptions(t *testing.T) *kvmutilsoptions.KvmCreateVmOptions {
	t.Helper()

	createOptions := kvmutilsoptions.NewKvmCreateVmOptions()
...
func newTestCreateOptionsWithoutMac(t *testing.T) *kvmutilsoptions.KvmCreateVmOptions {
	t.Helper()
...
func TestLibvirtXmls_CreateXmlForVmAsString(t *testing.T) {
	t.Run("nil createOptions returns error", func(t *testing.T) {
		_, err := kvmutilsgeneric.CreateXmlForVmAsString(nil)
		require.Error(t, err)
	})

	t.Run("rendered xml contains the vm name", func(t *testing.T) {
		xmlString, err := kvmutilsgeneric.CreateXmlForVmAsString(newTestCreateOptions(t))
	...
	t.Run("rendered xml is valid libvirt domain xml", func(t *testing.T) {
		...
		parsedMac, err := kvmutilsgeneric.GetMacAddressFromXmlString(xmlString)
		require.NoError(t, err)
...
func TestLibvirtXmls_MacAddressIsOptional(t *testing.T) {
	t.Run("renders successfully without a mac address", func(t *testing.T) {
		xmlString, err := kvmutilsgeneric.CreateXmlForVmAsString(newTestCreateOptionsWithoutMac(t))
		require.NoError(t, err)
	...
	t.Run("empty mac still renders (explicit empty string)", func(t *testing.T) {
		...
		xmlString, err := kvmutilsgeneric.CreateXmlForVmAsString(createOptions)
		require.NoError(t, err)
		require.NotContains(t, xmlString, "<mac address=")
	})
	...
	t.Run("invalid mac still returns error when provided", func(t *testing.T) {
		...
		_, err := kvmutilsgeneric.CreateXmlForVmAsString(createOptions)
		require.Error(t, err)
	})
...
func TestLibvirtXmls_GetMacAddressFromXmlString(t *testing.T) {
	t.Run("empty string returns error", func(t *testing.T) {
		_, err := kvmutilsgeneric.GetMacAddressFromXmlString("")
		require.Error(t, err)
	})

	t.Run("invalid xml returns error", func(t *testing.T) {
		_, err := kvmutilsgeneric.GetMacAddressFromXmlString("this is not xml")
		require.Error(t, err)
	})
