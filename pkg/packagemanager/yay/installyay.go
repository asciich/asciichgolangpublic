	...
	if isInstalled {
		...
		_, err = commandExecutor.RunCommand(ctx,
			&parameteroptions.RunCommandOptions{
				Command:   []string{"chown", "-R", yayInstallationUser, yayRepoPath},
