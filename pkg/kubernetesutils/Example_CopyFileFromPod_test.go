...
func TestCopyFileFromPod_nativeKubernetes(t *testing.T) {
...
func TestCopyFileFromPod_commandExecutor(t *testing.T) {
	ctx := contextutils.WithVerbose(context.TODO())
...
func TestCopyFileFromPod_roundTrip(t *testing.T) {
	ctx := contextutils.WithVerbose(context.TODO())
