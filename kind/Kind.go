...
type Kind interface {
	...
	CreateClusterByName(clusterName string, verbose bool) (cluster kubernetes.Cluster, err error)
	...
	MustCreateClusterByName(clusterName string, verbose bool) (cluster kubernetes.Cluster)
