...
type GitRepository interface {
	...
	MustAddRemote(options *gitparameteroptions.GitRemoteAddOptions)
	...
	MustCommit(commitOptions *gitparameteroptions.GitCommitOptions) (createdCommit *GitCommit)
	...
	MustCreateTag(createOptions *gitparameteroptions.GitRepositoryCreateTagOptions) (createdTag GitTag)
	...
	MustSetGitConfig(options *gitparameteroptions.GitConfigSetOptions)
	...
	MustCommitAndPush(commitOptions *gitparameteroptions.GitCommitOptions) (createdCommit *GitCommit)
	MustCommitIfUncommittedChanges(commitOptions *gitparameteroptions.GitCommitOptions) (createdCommit *GitCommit)
