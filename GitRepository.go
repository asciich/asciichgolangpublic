...
type GitRepository interface {
	...
	Commit(commitOptions *gitparameteroptions.GitCommitOptions) (createdCommit *GenericGitCommit, err error)
	...
	GetCommitParentsByCommitHash(hash string, options *parameteroptions.GitCommitGetParentsOptions) (commitParents []*GenericGitCommit, err error)
	...
	GetCurrentCommit(verbose bool) (commit *GenericGitCommit, err error)
	...
	CommitAndPush(commitOptions *gitparameteroptions.GitCommitOptions) (createdCommit *GenericGitCommit, err error)
	CommitIfUncommittedChanges(commitOptions *gitparameteroptions.GitCommitOptions) (createdCommit *GenericGitCommit, err error)
